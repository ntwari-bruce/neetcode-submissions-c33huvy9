class Solution:
    def validTree(self, n: int, edges: List[List[int]]) -> bool:
        ...
        # for the new algorithm, each node will have two neighbors, a parent and unvisitied which we're going to visit
        # it another neighbor has been visited, then we've detected a cycle. 
